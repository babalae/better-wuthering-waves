...
public partial class MainWindowViewModel : ObservableObject, IViewModel
{
    ...
    public string Title => $"BetterWW · 更好的鸣潮 · {Global.Version}{(RuntimeHelper.IsDebug ? " · Dev" : string.Empty)}";
    ...
    {
        _logger.LogInformation("更好的鸣潮 {Version}", Global.Version);
        // try
        // {
        //     await Task.Run(() =>
        //     {
        ...
        //     _logger.LogWarning("获取 BetterWW 最新版本信息失败");
        // }
    }
